...
ok( crispr_assembly() eq "GRCH38 output required","GRCH38  crispr output required" );
ok(crispr_assembly() eq "GRCH37 output required","GRCH37 crispr assembly output required");
ok( crispr_assembly() eq " slice on old assembly","slice on old assembly required" );
ok( crispr_assembly() eq " slice on new assembly","slice on new assembly required" );
